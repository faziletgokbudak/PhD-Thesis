...
The contributions made in this thesis address the core challenges faced by appearance manipulation, particularly the scarcity of training data and the complexity of capturing realistic transformations. By focusing on generalisable approaches that can work effectively with limited data, we presented methods that overcome the bottlenecks of traditional and machine learning-based techniques. The proposed models, which leverage the power of deep learning and neural fields, allow for precise control over intricate details, transient attributes, and reflectance. Our findings open new possibilities for realistic and efficient appearance manipulation across a wide range of real-world applications, pushing the boundaries of what can be achieved through data-driven methods.
