...
\section{Compression}
Table \ref{table: oursvsnps} reports quantitative comparison with IPCA \cite{nielsen2015optimal} and NPs \cite{zheng2021compact} and includes average metric values across the full MERL dataset of 100 materials. Additional qualitative comparison results that were included in the calculation of Table \ref{table: oursvsnps} can be found below.
