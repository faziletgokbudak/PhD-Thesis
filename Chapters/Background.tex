...
\begin{figure}[ht]
  \centering
  % \fbox{\rule{0pt}{2in} \rule{0.9\linewidth}{0pt}}
   \includegraphics[width=0.75\linewidth]{Images/perspective_projection.png}
...
\begin{figure}[ht]
  \centering
  % \fbox{\rule{0pt}{2in} \rule{0.9\linewidth}{0pt}}
   \includegraphics[width=0.45\linewidth, height=4.5cm]{Images/single_point_perspective.png}
    \includegraphics[width=0.45\linewidth, height=4.5cm]{Images/two_points_perspective.png}
...
\begin{figure}
  \centering
   \includegraphics[width=0.75\linewidth]{Images/ray-tracing-image-1.jpg}
...
\begin{figure}[ht]
  \centering
  % \fbox{\rule{0pt}{2in} \rule{0.9\linewidth}{0pt}}
   \includegraphics[width=0.75\linewidth]{Images/diffuse+specular+angle.pdf}
